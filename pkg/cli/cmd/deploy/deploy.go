...
Git Workspace Mode:
When run without a file argument in a Git repository with a .radius/ directory, 
rad deploy executes the deployment plan generated by 'rad plan'.
`,
		Example: `
...
# Git workspace mode: deploy from a generated plan
rad deploy

# Git workspace mode: deploy a specific application/environment
rad deploy -a myapp -e production

# Git workspace mode: skip confirmation prompts
rad deploy -y
`,
	...
	// Git workspace mode flags
	cmd.Flags().Bool("auto-commit", false, "Auto-commit the deployment record (Git workspace mode)")
	cmd.Flags().String("commit", "", "Deploy from a specific commit (Git workspace mode)")
	cmd.Flags().String("commit-message", "", "Custom commit message for deployment record (Git workspace mode)")
	cmd.Flags().BoolP("quiet", "q", false, "Minimal output (Git workspace mode)")
	cmd.Flags().BoolP("yes", "y", false, "Skip confirmation prompts (Git workspace mode)")
