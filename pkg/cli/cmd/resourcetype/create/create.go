...
func (r *Runner) Validate(cmd *cobra.Command, args []string) error {
	...
	if workspace.IsGitHubWorkspace() {
		return clierrors.Message("Resource type creation is not supported in GitHub mode. Resource types are managed through the RADIUS_CONFIG_REPO. Use 'rad resource-type list' to view available types.")
	}
